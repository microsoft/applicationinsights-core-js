/*!
 * Application Insights JavaScript SDK - Web, 1.0.0-beta.2
 * Copyright (c) Microsoft and contributors. All rights reserved.
 */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
    typeof define === 'function' && define.amd ? define(['exports'], factory) :
    (factory((global.Microsoft = {})));
    ...
    */
    ...
    var CoreUtils$1 = /** @class */ (function () {
        function CoreUtils() {
        }
        CoreUtils.isNullOrUndefined = function (input) {
            return input === null || input === undefined;
    ...
    */
        CoreUtils.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(GuidRegex$1, function (c) {
                // tslint:disable-next-line:insecure-random
                var r = (Math.random() * 16 | 0), v = (c === 'x' ? r : r & 0x3 | 0x8);
                return v.toString(16);
            });
    ...
    var GuidRegex$1 = /[xy]/g;

    /**
     * Class to manage sending notifications to all the listeners.
     */

    var LoggingSeverity$1;
    (function (LoggingSeverity) {
        /**
         * Error will be sent as internal telemetry
         */
         ...
         */
        LoggingSeverity[LoggingSeverity["WARNING"] = 2] = "WARNING";
    })(LoggingSeverity$1 || (LoggingSeverity$1 = {}));
    /**
     * Internal message ID. Please create a new one for every conceptually different message. Please keep alphabetically ordered
     */
    var _InternalMessageId$1 = {
        // Non user actionable
        BrowserDoesNotSupportLocalStorage: 0,
        BrowserCannotReadLocalStorage: 1,
        BrowserCannotReadSessionStorage: 2,
    ...
    var ChannelController$1 = /** @class */ (function () {
        function ChannelController() {
            this.identifier = "ChannelControllerPlugin";
            this.priority = ChannelControllerPriority$1; // in reserved range 100 to 200
        }
        ChannelController.prototype.processTelemetry = function (item) {
            this.channelQueue.forEach(function (queues) {
                // pass on to first item in queue
        ...
        ChannelController.prototype.initialize = function (config, core, extensions) {
            ...
            if (config.channels) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    var plugin = extensions[i];
                    if (plugin.priority > ChannelControllerPriority$1) {
                        arr.push(plugin);
                    }
                }
                if (arr.length > 0) {
    ...
    var ChannelControllerPriority$1 = 200;
    ...
    var DataSanitizer = /** @class */ (function () {
        ...
        DataSanitizer.sanitizeKey = function (logger, name) {
            if (name) {
                ...
                if (name.length > DataSanitizer.MAX_NAME_LENGTH) {
                    ...
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.NameTooLong, "name is too long.  It has been truncated to " + DataSanitizer.MAX_NAME_LENGTH + " characters.", { name: name }, true);
                }
            }
            return name;
        };
        DataSanitizer.sanitizeString = function (logger, value, maxLength) {
            ...
            if (value) {
                ...
                if (value.toString().length > maxLength) {
                    ...
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.StringValueTooLong, "string value is too long. It has been truncated to " + maxLength + " characters.", { value: value }, true);
                }
            }
            return value;
        };
        DataSanitizer.sanitizeUrl = function (logger, url) {
            return DataSanitizer.sanitizeInput(logger, url, DataSanitizer.MAX_URL_LENGTH, _InternalMessageId$1.UrlTooLong);
        };
        DataSanitizer.sanitizeMessage = function (logger, message) {
            if (message) {
                if (message.length > DataSanitizer.MAX_MESSAGE_LENGTH) {
                    message = message.substring(0, DataSanitizer.MAX_MESSAGE_LENGTH);
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.MessageTruncated, "message is too long, it has been truncated to " + DataSanitizer.MAX_MESSAGE_LENGTH + " characters.", { message: message }, true);
                }
            }
            return message;
        };
        DataSanitizer.sanitizeException = function (logger, exception) {
            if (exception) {
                if (exception.length > DataSanitizer.MAX_EXCEPTION_LENGTH) {
                    ...
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.ExceptionTruncated, "exception is too long, it has been truncated to " + DataSanitizer.MAX_EXCEPTION_LENGTH + " characters.", { exception: exception }, true);
                }
            }
            return exception;
        };
        ...
        DataSanitizer.sanitizeId = function (logger, id) {
            return id ? DataSanitizer.sanitizeInput(logger, id, DataSanitizer.MAX_ID_LENGTH, _InternalMessageId$1.IdTooLong).toString() : id;
        };
        DataSanitizer.sanitizeInput = function (logger, input, maxLength, _msgId) {
            if (input) {
                ...
                if (input.length > maxLength) {
                    ...
                    logger.throwInternal(LoggingSeverity$1.WARNING, _msgId, "input is too long, it has been truncated to " + maxLength + " characters.", { data: input }, true);
                }
            }
            return input;
        };
        ...
        Util.getStorage = function (logger, name) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseLocalStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserCannotReadLocalStorage, "Browser failed read of local storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return null;
        };
        ...
        Util.setStorage = function (logger, name, data) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseLocalStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserCannotWriteLocalStorage, "Browser failed write to local storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return false;
        };
        ...
        Util.removeStorage = function (logger, name) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseLocalStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserFailedRemovalFromLocalStorage, "Browser failed removal of local storage item. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return false;
        };
        ...
        Util.getSessionStorage = function (logger, name) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseSessionStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserCannotReadSessionStorage, "Browser failed read of session storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return null;
        };
        ...
        Util.setSessionStorage = function (logger, name, data) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseSessionStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserCannotWriteSessionStorage, "Browser failed write to session storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return false;
        };
        ...
        Util.removeSessionStorage = function (logger, name) {
            ...
            if (storage !== null) {
                try {
                    ...
                    Util._canUseSessionStorage = false;
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.BrowserFailedRemovalFromSessionStorage, "Browser failed removal of session storage item. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
            return false;
        };
        ...
        Util.canUseCookies = function (logger) {
            if (Util._canUseCookies === undefined) {
                ...
                try {
                    ...
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.CannotAccessCookie, "Cannot access document.cookie - " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
    ...
    var DateTimeUtils = /** @class */ (function () {
        ...
        DateTimeUtils.GetDuration = function (start, end) {
            var result = null;
            if (start !== 0 && end !== 0 && !CoreUtils$1.isNullOrUndefined(start) && !CoreUtils$1.isNullOrUndefined(end)) {
                result = end - start;
            }
            return result;
        };
    ...
    var PageViewPerformance = /** @class */ (function (_super) {
        ...
        function PageViewPerformance(logger, name, url, unused, properties, measurements) {
            ...
            if (timing) {
                ...
                if (total == 0) {
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.ErrorPVCalc, "error calculating page view performance.", { total: total, network: network, request: request, response: response, dom: dom });
                }
                else if (!PageViewPerformance.shouldCollectDuration(total, network, request, response, dom)) {
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.InvalidDurationValue, "Invalid page load duration value. Browser perf data won't be sent.", { total: total, network: network, request: request, response: response, dom: dom });
                }
                else if (total < Math.floor(network) + Math.floor(request) + Math.floor(response) + Math.floor(dom)) {
                    // some browsers may report individual components incorrectly so that the sum of the parts will be bigger than total PLT
                    // in this case, don't report client performance from this page
                    logger.throwInternal(LoggingSeverity$1.WARNING, _InternalMessageId$1.ClientPerformanceMathError, "client performance math error.", { total: total, network: network, request: request, response: response, dom: dom });
                }
                else {
    ...
    */
    ...
    var ConfigurationManager = /** @class */ (function () {
        ...
        ConfigurationManager.getConfig = function (config, field, identifier, defaultValue) {
            ...
            return !CoreUtils$1.isNullOrUndefined(configValue) ? configValue : defaultValue;
        };
    ...
    var TelemetryItemCreator = /** @class */ (function () {
        ...
        TelemetryItemCreator.create = function (item, baseType, envelopeName, logger, customProperties, systemProperties) {
            ...
            if (CoreUtils$1.isNullOrUndefined(item) ||
                CoreUtils$1.isNullOrUndefined(baseType) ||
                CoreUtils$1.isNullOrUndefined(envelopeName)) {
            ...
            // Part C
            if (!CoreUtils$1.isNullOrUndefined(customProperties)) {
    ...
    var partAExtensions$$1 = new PartAExtensions(kys); // export global instance

    var CoreUtils$2 = /** @class */ (function () {
        function CoreUtils() {
        }
        CoreUtils.isNullOrUndefined = function (input) {
            return input === null || input === undefined;
    ...
    */
        CoreUtils.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(GuidRegex$2, function (c) {
                // tslint:disable-next-line:insecure-random
                var r = (Math.random() * 16 | 0), v = (c === 'x' ? r : r & 0x3 | 0x8);
                return v.toString(16);
            });
    ...
    var GuidRegex$2 = /[xy]/g;

    /**
     * Class to manage sending notifications to all the listeners.
     */

    var LoggingSeverity$2;
    (function (LoggingSeverity) {
        /**
         * Error will be sent as internal telemetry
         */
         ...
         */
        LoggingSeverity[LoggingSeverity["WARNING"] = 2] = "WARNING";
    })(LoggingSeverity$2 || (LoggingSeverity$2 = {}));
    /**
     * Internal message ID. Please create a new one for every conceptually different message. Please keep alphabetically ordered
     */
    var _InternalMessageId$2 = {
        // Non user actionable
        BrowserDoesNotSupportLocalStorage: 0,
        BrowserCannotReadLocalStorage: 1,
        BrowserCannotReadSessionStorage: 2,
    ...
    var ChannelController$2 = /** @class */ (function () {
        function ChannelController() {
            this.identifier = "ChannelControllerPlugin";
            this.priority = ChannelControllerPriority$2; // in reserved range 100 to 200
        }
        ChannelController.prototype.processTelemetry = function (item) {
            this.channelQueue.forEach(function (queues) {
                // pass on to first item in queue
        ...
        ChannelController.prototype.initialize = function (config, core, extensions) {
            ...
            if (config.channels) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    var plugin = extensions[i];
                    if (plugin.priority > ChannelControllerPriority$2) {
                        arr.push(plugin);
                    }
                }
                if (arr.length > 0) {
    ...
    var ChannelControllerPriority$2 = 200;
    ...
    */
    var PageViewManager = /** @class */ (function () {
        ...
        */
        PageViewManager.prototype.trackPageView = function (pageView, customProperties) {
            ...
            if (CoreUtils$2.isNullOrUndefined(name) || typeof name !== "string") {
                pageView.name = window.document && window.document.title || "";
            }
            var uri = pageView.uri;
            if (CoreUtils$2.isNullOrUndefined(uri) || typeof uri !== "string") {
            ...
            if (!PageViewPerformance.isPerformanceTimingSupported()) {
                ...
                this._logger.throwInternal(LoggingSeverity$2.WARNING, _InternalMessageId$2.NavigationTimingNotSupported, "trackPageView: navigation timing API used for calculation of page duration is not supported in this browser. This page view will be collected without duration and timing info.");
                return;
            }
            ...
            var duration = undefined;
            if (!CoreUtils$2.isNullOrUndefined(customProperties) &&
                !CoreUtils$2.isNullOrUndefined(customProperties.duration)) {
            ...
            var handle = setInterval((function () {
                try {
                    ...
                    _this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.TrackPVFailedCalc, "trackPageView failed on page load calculation: " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }), 100);
        };
    ...
    var ApplicationInsights = /** @class */ (function () {
        ...
        ApplicationInsights.prototype.processTelemetry = function (env) {
            ...
            try {
                ...
                doNotSendItem = true;
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.TelemetryInitializerFailed, "One of telemetry initializers failed, telemetry item will not be sent: " + Util.getExceptionName(e), { exception: Util.dump(e) }, true);
            }
            if (!doNotSendItem && !CoreUtils$2.isNullOrUndefined(this._nextPlugin)) {
        ...
        ApplicationInsights.prototype.trackEvent = function (event, customProperties) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.WARNING, _InternalMessageId$2.TrackTraceFailed, "trackTrace failed, trace will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackMetric = function (metric, customProperties) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.TrackMetricFailed, "trackMetric failed, metric will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackPageView = function (pageView, customProperties) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.TrackPVFailed, "trackPageView failed, page view will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.startTrackPage = function (name) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.StartTrackFailed, "startTrackPage failed, page view may not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.stopTrackPage = function (name, url, properties) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.StopTrackFailed, "stopTrackPage failed, page view will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackException = function (exception, customProperties) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.TrackExceptionFailed, "trackException failed, exception will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype._onerror = function (exception) {
            try {
                ...
                var errorString = exception.error ?
                    ...
                    : "null";
                this._logger.throwInternal(LoggingSeverity$2.CRITICAL, _InternalMessageId$2.ExceptionWhileLoggingError, "_onError threw exception while logging error, error will not be collected: "
        ...
        ApplicationInsights.prototype._initialize = function (config, core, extensions) {
            ...
            if (CoreUtils$2.isNullOrUndefined(core)) {
            ...
            this._pageTracking.action = function (name, url, duration, properties) {
                ...
                if (CoreUtils$2.isNullOrUndefined(properties)) {
                    properties = {};
                }
    ...
    var Timing = /** @class */ (function () {
        ...
        Timing.prototype.start = function (name) {
            if (typeof this._events[name] !== "undefined") {
                this._logger.throwInternal(LoggingSeverity$2.WARNING, _InternalMessageId$2.StartCalledMoreThanOnce, "start was called more than once for this event without calling stop.", { name: this._name, key: name }, true);
            }
        ...
        Timing.prototype.stop = function (name, url, properties) {
            ...
            if (isNaN(start)) {
                this._logger.throwInternal(LoggingSeverity$2.WARNING, _InternalMessageId$2.StopCalledWithoutStart, "stop was called without a corresponding start.", { name: this._name, key: name }, true);
            }
            else {
                var end = +new Date;
    ...
    var CoreUtils$3 = /** @class */ (function () {
        function CoreUtils() {
        }
        CoreUtils.isNullOrUndefined = function (input) {
            return input === null || input === undefined;
    ...
    */
        CoreUtils.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(GuidRegex$3, function (c) {
                // tslint:disable-next-line:insecure-random
                var r = (Math.random() * 16 | 0), v = (c === 'x' ? r : r & 0x3 | 0x8);
                return v.toString(16);
            });
    ...
    var GuidRegex$3 = /[xy]/g;

    /**
     * Class to manage sending notifications to all the listeners.
     */

    var LoggingSeverity$3;
    (function (LoggingSeverity) {
        /**
         * Error will be sent as internal telemetry
         */
         ...
         */
        LoggingSeverity[LoggingSeverity["WARNING"] = 2] = "WARNING";
    })(LoggingSeverity$3 || (LoggingSeverity$3 = {}));
    /**
     * Internal message ID. Please create a new one for every conceptually different message. Please keep alphabetically ordered
     */
    var _InternalMessageId$3 = {
        // Non user actionable
        BrowserDoesNotSupportLocalStorage: 0,
        BrowserCannotReadLocalStorage: 1,
        BrowserCannotReadSessionStorage: 2,
    ...
    var ChannelController$3 = /** @class */ (function () {
        function ChannelController() {
            this.identifier = "ChannelControllerPlugin";
            this.priority = ChannelControllerPriority$3; // in reserved range 100 to 200
        }
        ChannelController.prototype.processTelemetry = function (item) {
            this.channelQueue.forEach(function (queues) {
                // pass on to first item in queue
        ...
        ChannelController.prototype.initialize = function (config, core, extensions) {
            ...
            if (config.channels) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    var plugin = extensions[i];
                    if (plugin.priority > ChannelControllerPriority$3) {
                        arr.push(plugin);
                    }
                }
                if (arr.length > 0) {
    ...
    var ChannelControllerPriority$3 = 200;
    ...
    var SessionStorageSendBuffer = /** @class */ (function () {
        ...
        SessionStorageSendBuffer.prototype.enqueue = function (payload) {
            if (this._buffer.length >= SessionStorageSendBuffer.MAX_BUFFER_SIZE) {
                ...
                if (!this._bufferFullMessageSent) {
                    this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.SessionStorageBufferFull, "Maximum buffer size reached: " + this._buffer.length, true);
        ...
        SessionStorageSendBuffer.prototype.markAsSent = function (payload) {
            ...
            if (sentElements instanceof Array && payload instanceof Array) {
                ...
                if (sentElements.length > SessionStorageSendBuffer.MAX_BUFFER_SIZE) {
                    ...
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.SessionStorageBufferFull, "Sent buffer reached its maximum size: " + sentElements.length, true);
        ...
        SessionStorageSendBuffer.prototype.getBuffer = function (key) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.FailedToRestoreStorageBuffer, " storage key: " + key + ", " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
            return [];
        };
        SessionStorageSendBuffer.prototype.setBuffer = function (key, buffer) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.FailedToSetStorageBuffer, " storage key: " + key + ", " + Util.getExceptionName(e) + ". Buffer cleared", { exception: Util.dump(e) });
            }
        };
    ...
    ***************************************************************************** */
    ...
    var EnvelopeCreator = /** @class */ (function () {
        ...
        EnvelopeCreator.extractPropsAndMeasurements = function (data, properties, measurements) {
            if (!CoreUtils$3.isNullOrUndefined(data)) {
                for (var key in data) {
                    if (data.hasOwnProperty(key)) {
                        var value = data[key];
                        if (typeof value === "number") {
        ...
        EnvelopeCreator.extractPartAExtensions = function (telemetryItem, envelope) {
            var extensions = [];
            extensions.push(partAExtensions$$1.UserExtensionName);
            extensions.forEach(function (extName) {
                var e = telemetryItem.tags[extName] || {};
                EnvelopeCreator.parseProperties(envelope, e, partAExtensions$$1.userTagsKeysMap);
                var t = telemetryItem.ctx[extName] || {};
                EnvelopeCreator.parseProperties(envelope, t, partAExtensions$$1.userExtKeysMap);
            });
        };
    ...
    var DependencyEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(DependencyEnvelopeCreator, _super);
        function DependencyEnvelopeCreator() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        DependencyEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            this._logger = logger;
            if (CoreUtils$3.isNullOrUndefined(telemetryItem.baseData)) {
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.TelemetryEnvelopeInvalid, "telemetryItem.baseData cannot be null.");
            }
            var customMeasurements = {};
            var customProperties = {};
            EnvelopeCreator.extractPropsAndMeasurements(telemetryItem.data, customProperties, customMeasurements);
            var bd = telemetryItem.baseData;
            if (CoreUtils$3.isNullOrUndefined(bd)) {
    ...
    var EventEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(EventEnvelopeCreator, _super);
    ...
    var ExceptionEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(ExceptionEnvelopeCreator, _super);
    ...
    var MetricEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(MetricEnvelopeCreator, _super);
    ...
    var PageViewEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(PageViewEnvelopeCreator, _super);
        ...
        PageViewEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            ...
            var duration = undefined;
            if (!CoreUtils$3.isNullOrUndefined(telemetryItem.data) &&
                !CoreUtils$3.isNullOrUndefined(telemetryItem.data.duration)) {
            ...
            if (!CoreUtils$3.isNullOrUndefined(telemetryItem.baseData.refUri)) {
                customProperties["refUri"] = telemetryItem.baseData.refUri;
            }
            // pageType is a field that Breeze still does not recognize as part of Part B. For now, put it in Part C until it supports it as a domain property
            if (!CoreUtils$3.isNullOrUndefined(telemetryItem.baseData.pageType)) {
                customProperties["pageType"] = telemetryItem.baseData.pageType;
            }
            // isLoggedIn is a field that Breeze still does not recognize as part of Part B. For now, put it in Part C until it supports it as a domain property
            if (!CoreUtils$3.isNullOrUndefined(telemetryItem.baseData.isLoggedIn)) {
                customProperties["isLoggedIn"] = telemetryItem.baseData.isLoggedIn;
            }
            // pageTags is a field that Breeze still does not recognize as part of Part B. For now, put it in Part C until it supports it as a domain property
            if (!CoreUtils$3.isNullOrUndefined(telemetryItem.baseData.pageTags)) {
    ...
    var PageViewPerformanceEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(PageViewPerformanceEnvelopeCreator, _super);
    ...
    var TraceEnvelopeCreator = /** @class */ (function (_super) {
        __extends$1(TraceEnvelopeCreator, _super);
    ...
    var Serializer = /** @class */ (function () {
        ...
        Serializer.prototype._serializeObject = function (source, name) {
            ...
            var output = {};
            if (!source) {
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.CannotSerializeObject, "cannot serialize object because it is null or undefined", { name: name }, true);
                return output;
            }
            if (source[circularReferenceCheck]) {
                this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.CircularReferenceDetected, "Circular reference detected while serializing object", { name: name }, true);
                return output;
            }
            if (!source.aiDataContract) {
                ...
                if (name === "measurements") {
                    ...
                    this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.CannotSerializeObjectNonSerializable, "Attempting to serialize an object which does not implement ISerializable", { name: name }, true);
                    try {
                        ...
                        this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.CannotSerializeObject, (e && typeof e.toString === 'function') ? e.toString() : "Error serializing object", null, true);
                    }
                }
                return output;
            }
            ...
            for (var field in source.aiDataContract) {
                ...
                if (isRequired && !isPresent && !isArray) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.MissingRequiredFieldSpecification, "Missing required field specification. The field is required but not present on source", { field: field, name: name });
        ...
        Serializer.prototype._serializeArray = function (sources, name) {
            ...
            if (!!sources) {
                if (!Util.isArray(sources)) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.ItemNotInArray, "This field was specified as an array in the contract but the item is not an array.\r\n", { name: name }, true);
                }
                else {
                    output = [];
            ...
            if (map) {
                ...
                for (var field in map) {
                    ...
                    if (expectedType === "string") {
                        ...
                        this._logger.throwInternal(LoggingSeverity$3.CRITICAL, output[field], null, true);
                    }
                }
            }
            return output;
    ...
    var Sender = /** @class */ (function () {
        ...
        Sender.prototype.flush = function () {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.FlushFailed, "flush failed, telemetry will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        ...
        Sender.prototype.processTelemetry = function (telemetryItem) {
            try {
                ...
                // validate input
                if (!telemetryItem) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.CannotSendEmptyTelemetry, "Cannot send empty telemetry");
                    return;
                }
                // ensure a sender was constructed
                if (!this._sender) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.SenderNotInitialized, "Sender was not initialized");
                    return;
                }
                // first we need to validate that the envelope passed down is valid
                var isValid = Sender._validate(telemetryItem);
                if (!isValid) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.TelemetryEnvelopeInvalid, "Invalid telemetry envelope");
                    return;
                }
                // construct an envelope that Application Insights endpoint can understand
                var aiEnvelope = this._constructEnvelope(telemetryItem);
                if (!aiEnvelope) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.CreateEnvelopeError, "Unable to create an AppInsights envelope");
                    return;
                }
                ...
                this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.FailedAddingTelemetryToBuffer, "Failed adding telemetry to the sender's buffer, some telemetry will be lost: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
            // hand off the telemetry item to the next plugin
            if (!CoreUtils$3.isNullOrUndefined(this._nextPlugin)) {
            ...
            if (xhr.readyState === 4) {
                ...
                if ((xhr.status < 200 || xhr.status >= 300) && xhr.status !== 0) {
                    if (!this._config.isRetryDisabled() && this._isRetriable(xhr.status)) {
                        ...
                        this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.TransmissionFailed, ". " +
                    ...
                    if (!this._config.isRetryDisabled()) {
                        ...
                        this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.TransmissionFailed, ". Offline - Response Code: " + xhr.status + ". Offline status: " + Offline.isOffline() + ". Will retry to send " + payload.length + " items.");
                    }
                }
                else {
                    if (xhr.status === 206) {
        ...
        Sender.prototype.triggerSend = function (async) {
            ...
            try {
                ...
                if (!Util.getIEVersion() || Util.getIEVersion() > 9) {
                    this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.TransmissionFailed, "Telemetry transmission failed, some telemetry will be lost: " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
        };
        /**
        ...
        Sender.prototype._onError = function (payload, message, event) {
            this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.OnError, "Failed to send telemetry.", { message: message });
        ...
        Sender.prototype._onPartialSuccess = function (payload, results) {
            ...
            if (retry.length > 0) {
                ...
                this._logger.throwInternal(LoggingSeverity$3.WARNING, _InternalMessageId$3.TransmissionFailed, "Partial success. " +
        ...
        Sender.prototype._beaconSender = function (payload, isAsync) {
            ...
            if (queued) {
                ...
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.TransmissionFailed, ". " + "Failed to send telemetry with Beacon API.");
            }
        };
        /**
         * Send XMLHttpRequest
        ...
        Sender.prototype._parseResponse = function (response) {
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$3.CRITICAL, _InternalMessageId$3.InvalidBackendResponse, "Cannot parse the response. " + Util.getExceptionName(e), {
                    response: response
                });
            }
            return null;
    ...
    var CoreUtils$4 = /** @class */ (function () {
        function CoreUtils() {
        }
        CoreUtils.isNullOrUndefined = function (input) {
            return input === null || input === undefined;
    ...
    */
        CoreUtils.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(GuidRegex$4, function (c) {
                // tslint:disable-next-line:insecure-random
                var r = (Math.random() * 16 | 0), v = (c === 'x' ? r : r & 0x3 | 0x8);
                return v.toString(16);
            });
    ...
    var GuidRegex$4 = /[xy]/g;

    /**
     * Class to manage sending notifications to all the listeners.
     */

    var LoggingSeverity$4;
    (function (LoggingSeverity) {
        /**
         * Error will be sent as internal telemetry
         */
         ...
         */
        LoggingSeverity[LoggingSeverity["WARNING"] = 2] = "WARNING";
    })(LoggingSeverity$4 || (LoggingSeverity$4 = {}));
    /**
     * Internal message ID. Please create a new one for every conceptually different message. Please keep alphabetically ordered
     */
    var _InternalMessageId$4 = {
        // Non user actionable
        BrowserDoesNotSupportLocalStorage: 0,
        BrowserCannotReadLocalStorage: 1,
        BrowserCannotReadSessionStorage: 2,
    ...
    var _InternalLogMessage$4 = /** @class */ (function () {
        function _InternalLogMessage(msgId, msg, isUserAct, properties) {
            if (isUserAct === void 0) { isUserAct = false; }
            this.messageId = msgId;
            this.message =
    ...
    var DiagnosticLogger$4 = /** @class */ (function () {
        function DiagnosticLogger(config) {
            /**
            *  Session storage key for the prefix for the key indicating message type already logged
            */
             ...
             */
            this._messageLogged = {};
            if (CoreUtils$4.isNullOrUndefined(config)) {
                // TODO: Use default config
                // config = AppInsightsCore.defaultConfig;
                // For now, use defaults specified in DiagnosticLogger members;
                return;
            }
            if (!CoreUtils$4.isNullOrUndefined(config.loggingLevelConsole)) {
                this.consoleLoggingLevel = function () { return config.loggingLevelConsole; };
            }
            if (!CoreUtils$4.isNullOrUndefined(config.loggingLevelTelemetry)) {
                this.telemetryLoggingLevel = function () { return config.loggingLevelTelemetry; };
            }
            if (!CoreUtils$4.isNullOrUndefined(config.maxMessageLimit)) {
                this.maxInternalMessageLimit = function () { return config.maxMessageLimit; };
            }
            if (!CoreUtils$4.isNullOrUndefined(config.enableDebugExceptions)) {
                this.enableDebugExceptions = function () { return config.enableDebugExceptions; };
            }
        }
        /**
        ...
        DiagnosticLogger.prototype.throwInternal = function (severity, msgId, msg, properties, isUserAct) {
            if (isUserAct === void 0) { isUserAct = false; }
            var message = new _InternalLogMessage$4(msgId, msg, isUserAct, properties);
            if (this.enableDebugExceptions()) {
                throw message;
            }
            else {
                if (typeof (message) !== "undefined" && !!message) {
                    if (typeof (message.message) !== "undefined") {
                        if (isUserAct) {
                            // check if this message type was already logged to console for this page view and if so, don't log it again
                            var messageKey = +message.messageId;
                            if (!this._messageLogged[messageKey] || this.consoleLoggingLevel() >= LoggingSeverity$4.WARNING) {
                                this.warnToConsole(message.message);
                                this._messageLogged[messageKey] = true;
                            }
                        }
                            ...
                            // don't log internal AI traces in the console, unless the verbose logging is enabled
                            if (this.consoleLoggingLevel() >= LoggingSeverity$4.WARNING) {
                                this.warnToConsole(message.message);
                            }
                        }
                        this.logInternalMessage(severity, message);
        ...
        DiagnosticLogger.prototype.logInternalMessage = function (severity, message) {
            ...
            if (logMessage) {
                ...
                if (this._messageCount == this.maxInternalMessageLimit()) {
                    var throttleLimitMessage = "Internal events throttle limit per PageView reached for this app.";
                    var throttleMessage = new _InternalLogMessage$4(_InternalMessageId$4.MessageLimitPerPVExceeded, throttleLimitMessage, false);
                    this.queue.push(throttleMessage);
                    this.warnToConsole(throttleLimitMessage);
                }
            }
    ...
    var ChannelController$4 = /** @class */ (function () {
        function ChannelController() {
            this.identifier = "ChannelControllerPlugin";
            this.priority = ChannelControllerPriority$4; // in reserved range 100 to 200
        }
        ChannelController.prototype.processTelemetry = function (item) {
            this.channelQueue.forEach(function (queues) {
                // pass on to first item in queue
        ...
        ChannelController.prototype.initialize = function (config, core, extensions) {
            ...
            if (config.channels) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    var plugin = extensions[i];
                    if (plugin.priority > ChannelControllerPriority$4) {
                        arr.push(plugin);
                    }
                }
                if (arr.length > 0) {
    ...
    var ChannelControllerPriority$4 = 200;
    ...
    var _SessionManager = /** @class */ (function () {
        function _SessionManager(config, logger) {
            if (CoreUtils$4.isNullOrUndefined(logger)) {
                this._logger = new DiagnosticLogger$4();
            }
            else {
                this._logger = logger;
            }
        ...
        _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
            ...
            try {
                ...
                this._logger.throwInternal(LoggingSeverity$4.CRITICAL, _InternalMessageId$4.ErrorParsingAISessionCookie, "Error parsing ai_session cookie, session will be reset: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
            if (this.automaticSession.renewalDate == 0) {
                this._logger.throwInternal(LoggingSeverity$4.WARNING, _InternalMessageId$4.SessionRenewalDateIsZero, "AI session renewal date is 0, session will be reset.");
            }
        };
        _SessionManager.prototype.renew = function () {
            ...
            if (!Util.canUseLocalStorage()) {
                this._logger.throwInternal(LoggingSeverity$4.WARNING, _InternalMessageId$4.BrowserDoesNotSupportLocalStorage, "Browser does not support local storage. Session durations will be inaccurate.");
            }
        };
    ...
    var User = /** @class */ (function () {
        ...
        */
        User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId, storeInCookie) {
            ...
            if (isInvalidInput) {
                this._logger.throwInternal(LoggingSeverity$4.WARNING, _InternalMessageId$4.SetAuthContextFailedAccountName, "Setting auth user context failed. " +
    ...
    var Sample = /** @class */ (function () {
        function Sample(sampleRate, logger) {
            ...
            if (sampleRate > 100 || sampleRate < 0) {
                this._logger.throwInternal(LoggingSeverity$4.WARNING, _InternalMessageId$4.SampleRateOutOfRange, "Sampling rate is out of range (0..100). Sampling will be disabled, you may be sending too much data which may affect your AI service level.", { samplingRate: sampleRate }, true);
                this.sampleRate = 100;
            }
    ...
    var PropertiesPlugin = /** @class */ (function () {
        ...
        PropertiesPlugin.prototype.processTelemetry = function (event) {
            if (CoreUtils$4.isNullOrUndefined(event)) ;
            else {
                ...
                if (!CoreUtils$4.isNullOrUndefined(this._nextPlugin)) {
        ...
        PropertiesPlugin.prototype._applyUserContext = function (event, userContext) {
            if (userContext) {
                ...
                if (typeof userContext.accountId === "string") {
                    var item = {};
                    item[partAExtensions$$1.accountIdTag] = userContext.accountId;
                ...
                event.ctx[partAExtensions$$1.UserExtensionName] = ctxExt; // part A extension
                // CS 4.0
            }
        };
    ...
    var CoreUtils$5 = /** @class */ (function () {
        function CoreUtils() {
        }
        CoreUtils.isNullOrUndefined = function (input) {
            return input === null || input === undefined;
    ...
    */
        CoreUtils.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(GuidRegex$5, function (c) {
                // tslint:disable-next-line:insecure-random
                var r = (Math.random() * 16 | 0), v = (c === 'x' ? r : r & 0x3 | 0x8);
                return v.toString(16);
            });
    ...
    var GuidRegex$5 = /[xy]/g;

    /**
     * Class to manage sending notifications to all the listeners.
     */

    var LoggingSeverity$5;
    (function (LoggingSeverity) {
        /**
         * Error will be sent as internal telemetry
         */
         ...
         */
        LoggingSeverity[LoggingSeverity["WARNING"] = 2] = "WARNING";
    })(LoggingSeverity$5 || (LoggingSeverity$5 = {}));
    /**
     * Internal message ID. Please create a new one for every conceptually different message. Please keep alphabetically ordered
     */
    var _InternalMessageId$5 = {
        // Non user actionable
        BrowserDoesNotSupportLocalStorage: 0,
        BrowserCannotReadLocalStorage: 1,
        BrowserCannotReadSessionStorage: 2,
    ...
    var ChannelController$5 = /** @class */ (function () {
        function ChannelController() {
            this.identifier = "ChannelControllerPlugin";
            this.priority = ChannelControllerPriority$5; // in reserved range 100 to 200
        }
        ChannelController.prototype.processTelemetry = function (item) {
            this.channelQueue.forEach(function (queues) {
                // pass on to first item in queue
        ...
        ChannelController.prototype.initialize = function (config, core, extensions) {
            ...
            if (config.channels) {
                ...
                for (var i = 0; i < extensions.length; i++) {
                    var plugin = extensions[i];
                    if (plugin.priority > ChannelControllerPriority$5) {
                        arr.push(plugin);
                    }
                }
                if (arr.length > 0) {
    ...
    var ChannelControllerPriority$5 = 200;
    ...
    var EventHelper = /** @class */ (function () {
        ...
        EventHelper.AttachEvent = function (obj, eventNameWithoutOn, handlerRef) {
            var result = false;
            if (!CoreUtils$5.isNullOrUndefined(obj)) {
                if (!CoreUtils$5.isNullOrUndefined(obj.attachEvent)) {
                    // IE before version 9                    
                    obj.attachEvent("on" + eventNameWithoutOn, handlerRef);
                    result = true;
                }
                else {
                    if (!CoreUtils$5.isNullOrUndefined(obj.addEventListener)) {
        ...
        EventHelper.DetachEvent = function (obj, eventNameWithoutOn, handlerRef) {
            if (!CoreUtils$5.isNullOrUndefined(obj)) {
                if (!CoreUtils$5.isNullOrUndefined(obj.detachEvent)) {
                    obj.detachEvent("on" + eventNameWithoutOn, handlerRef);
                }
                else {
                    if (!CoreUtils$5.isNullOrUndefined(obj.removeEventListener)) {
    ...
    var AjaxMonitor = /** @class */ (function () {
        ...
        AjaxMonitor.prototype.isMonitoredInstance = function (xhr, excludeAjaxDataValidation) {
            ...
            return this.initialized
                ...
                && (excludeAjaxDataValidation === true || !CoreUtils$5.isNullOrUndefined(xhr.ajaxData))
        ...
        AjaxMonitor.prototype.supportsAjaxMonitoring = function () {
            var result = true;
            if (CoreUtils$5.isNullOrUndefined(XMLHttpRequest) ||
                CoreUtils$5.isNullOrUndefined(XMLHttpRequest.prototype) ||
                CoreUtils$5.isNullOrUndefined(XMLHttpRequest.prototype.open) ||
                CoreUtils$5.isNullOrUndefined(XMLHttpRequest.prototype.send) ||
                CoreUtils$5.isNullOrUndefined(XMLHttpRequest.prototype.abort)) {
                result = false;
            }
        ...
        AjaxMonitor.prototype.instrumentOpen = function () {
            ...
            XMLHttpRequest.prototype.open = function (method, url, async) {
                try {
                    ...
                    this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxOpen, "Failed to monitor XMLHttpRequest.open, monitoring data for this ajax call may be incorrect.", {
        ...
        AjaxMonitor.getFailedAjaxDiagnosticsMessage = function (xhr) {
            var result = "";
            try {
                if (!CoreUtils$5.isNullOrUndefined(xhr) &&
                    !CoreUtils$5.isNullOrUndefined(xhr.ajaxData) &&
                    !CoreUtils$5.isNullOrUndefined(xhr.ajaxData.requestUrl)) {
        ...
        AjaxMonitor.prototype.instrumentSend = function () {
            ...
            XMLHttpRequest.prototype.send = function (content) {
                try {
                    ...
                    this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxSend, "Failed to monitor XMLHttpRequest, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
        ...
        AjaxMonitor.prototype.instrumentAbort = function () {
            ...
            XMLHttpRequest.prototype.abort = function () {
                try {
                    ...
                    this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxAbort, "Failed to monitor XMLHttpRequest.abort, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
            ...
            xhr.ajaxData.xhrMonitoringState.onreadystatechangeCallbackAttached = EventHelper.AttachEvent(xhr, "readystatechange", function () {
                try {
                    ...
                    if (!exceptionText || exceptionText.toLowerCase().indexOf("c00c023f") == -1) {
                        _this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxRSC, "Failed to monitor XMLHttpRequest 'readystatechange' event handler, monitoring data for this ajax call may be incorrect.", {
        ...
        AjaxMonitor.prototype.onAjaxComplete = function (xhr) {
            ...
            if (xhr.ajaxData.ajaxTotalDuration < 0) {
                this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxDur, "Failed to calculate the duration of the ajax call, monitoring data for this ajax call won't be sent.", {
                    ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
        ...
        AjaxMonitor.prototype.getAjaxCorrelationContext = function (xhr) {
            try {
                ...
                this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxGetCorrelationHeader, "Failed to get Request-Context correlation header as it may be not included in the response or not accessible.", {
                    ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
                    exception: Util.dump(e)
                });
            }
        ...
        AjaxMonitor.prototype.trackDependencyDataInternal = function (dependency, properties, systemProperties) {
            if (this._config.maxAjaxCallsPerView === -1 || this._trackAjaxAttempts < this._config.maxAjaxCallsPerView) {
                ...
                this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.MaxAjaxPerPVExceeded, "Maximum ajax per page view limit reached, ajax monitoring is paused until the next trackPageView(). In order to increase the limit set the maxAjaxCallsPerView configuration parameter.", true);
            }
            ...
            window.fetch = function fetch(input, init) {
                ...
                if (fetchMonitorInstance.isFetchInstrumented(input)) {
                    try {
                        ...
                        fetchMonitorInstance._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxOpen, "Failed to monitor Window.fetch, monitoring data for this fetch call may be incorrect.", {
        ...
        AjaxMonitor.prototype.supportsFetch = function () {
            var result = true;
            if (!window || CoreUtils$5.isNullOrUndefined(window.Request) ||
                CoreUtils$5.isNullOrUndefined(window.Request.prototype) ||
                CoreUtils$5.isNullOrUndefined(window.fetch)) {
                result = false;
            }
            return result;
        };
        ...
        AjaxMonitor.prototype.getFailedFetchDiagnosticsMessage = function (input) {
            var result = "";
            try {
                if (!CoreUtils$5.isNullOrUndefined(input)) {
                ...
                this._core.logger.throwInternal(LoggingSeverity$5.CRITICAL, _InternalMessageId$5.FailedMonitorAjaxOpen, "Failed to grab failed fetch diagnostics message", { exception: Util.dump(e) });
            }
            return result;
        };
        AjaxMonitor.prototype.onFetchComplete = function (response, ajaxData) {
            ...
            try {
                ...
                if (ajaxData.ajaxTotalDuration < 0) {
                    this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxDur, "Failed to calculate the duration of the fetch call, monitoring data for this fetch call won't be sent.", {
                ...
                this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxGetCorrelationHeader, "Failed to calculate the duration of the fetch call, monitoring data for this fetch call won't be sent.", {
                    fetchDiagnosticsMessage: this.getFailedFetchDiagnosticsMessage(response),
                    exception: Util.dump(e)
                });
            }
        ...
        AjaxMonitor.prototype.onFetchFailed = function (input, ajaxData, reason) {
            ...
            try {
                ...
                ajaxData.CalculateMetrics();
                if (ajaxData.ajaxTotalDuration < 0) {
                    this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxDur, "Failed to calculate the duration of the failed fetch call, monitoring data for this fetch call won't be sent.", {
                ...
                this._core.logger.throwInternal(LoggingSeverity$5.WARNING, _InternalMessageId$5.FailedMonitorAjaxGetCorrelationHeader, "Failed to calculate the duration of the failed fetch call, monitoring data for this fetch call won't be sent.", {
                    fetchDiagnosticsMessage: this.getFailedFetchDiagnosticsMessage(input),
                    exception: Util.dump(e)
                });
            }
...
//# sourceMappingURL=ai.1.0.0-beta.2.js.map
